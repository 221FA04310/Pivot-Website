    ...
    >
      ...
      {!hideCTA && (
        ...
        <div className="relative w-full h-full pointer-events-none z-20">
          ...
          >
            <h2 
              className="text-[#F8FAFC] tracking-tight select-none font-heading"
              style={{
          ...
          >
            <div className="max-w-[70vw] flex flex-col items-center justify-center gap-8 pointer-events-auto">
              ...
              >
                Partner with Pivot Software and Consultancy to turn your vision into a high-performance web or mobile application.
              </p>
              ...
              >
                <Link href="/contact">
                  <Button
                    variant="primary"
                    magnetic={true}
                    className="h-[58px] px-8 rounded-[18px] text-xs uppercase tracking-wider font-extrabold shadow-lg bg-[#27A7A2] hover:bg-[#1F6FA9] border-transparent text-white"
                  >
                ...
                <Link href="/contact">
                  <Button
                    variant="secondary"
                    magnetic={true}
                    className="h-[58px] px-8 rounded-[18px] text-xs uppercase tracking-wider font-extrabold border border-[#27A7A2] bg-white/5 text-white hover:bg-[#27A7A2] hover:border-[#27A7A2]"
                  >
      ...
      >
        ...
        >
          ...
          <div className="relative max-w-[1400px] mx-auto z-10 grid grid-cols-1 md:grid-cols-12 gap-16 pb-20">
            ...
            {/* Column 1 - Brand Info */}
            <div ref={logoRef} className="md:col-span-4 space-y-6 text-left">
              ...
              <p className="text-white/70 text-sm leading-relaxed max-w-sm">
                Pivot Software and Consultancy — Empowering businesses through advanced web development, applications, and custom digital solutions.
              </p>
            ...
            <div ref={companyColRef} className="md:col-span-2 space-y-6 text-left">
              ...
              <ul className="space-y-4 text-xs font-semibold uppercase tracking-wider">
                <li>
                  <Link href="/" className="group flex items-center gap-1.5 text-white/60 hover:text-[#27A7A2] transition-colors duration-300">
                    <span>Home</span>
                ...
                <li>
                  <Link href="#insights" className="group flex items-center gap-1.5 text-white/60 hover:text-[#27A7A2] transition-colors duration-300">
                    <span>Insights</span>
                    <span className="opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 text-[10px]">
                      →
                    </span>
          ...
          <div ref={bottomBarRef} className="relative max-w-[1400px] mx-auto border-t border-white/10 pt-8 z-10">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6 text-xs text-white/50">
              ...
              <div className="flex items-center gap-6 text-white/50 text-xs">
                ...
                <Link href="/contact" className="hover:text-[#27A7A2] transition-colors">Privacy Policy</Link>
                <span className="text-white/20">|</span>
                <Link href="/contact" className="hover:text-[#27A7A2] transition-colors">Terms of Service</Link>
              </div>
