...
export function Hero() {
  ...
  const slides = [
    {
      chapter: "Software & Digital Consultancy",
      heading: "Engineering Digital Excellence for Modern Businesses",
      subheading: "We build scalable web applications, robust e-commerce platforms, custom mobile apps, and automated systems that drive real business growth.",
      overlayClass: "from-[#071A2F]/95 via-[#071A2F]/65 to-transparent",
    },
    {
      chapter: "Scalable Web & Cloud Architecture",
      heading: "Engineering Digital Excellence for Modern Businesses",
      subheading: "From high-availability cloud migration to custom software automation, we turn complex technical challenges into scalable business growth.",
      overlayClass: "from-[#071A2F]/95 via-[#071A2F]/65 to-transparent",
    },
    {
      chapter: "Modern Application Ecosystems",
      heading: "Engineering Digital Excellence for Modern Businesses",
      subheading: "Partner with an engineering team dedicated to performance, zero-downtime scalability, and intuitive digital product experiences.",
      overlayClass: "from-[#071A2F]/95 via-[#071A2F]/65 to-transparent",
    },
  ];
          ...
          >
            ...
            <Link href="/contact">
              <Button
                variant="secondary"
                magnetic={true}
                className="h-[58px] px-8 rounded-[18px] text-base border border-white/20 bg-white/5 backdrop-blur-md text-white hover:bg-white/10 hover:border-[#27A7A2]"
              >
